...
\title{Validação Computacional da Probabilidade de Formação Triangular via Método de Monte Carlo: Integração com Prática Pedagógica no Ensino de Matemática}
\author{
